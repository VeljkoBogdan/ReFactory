GTCEuStartupEvents.registry('gtceu:machine', event => {
    ...
    event.create('crystal_puller', 'multiblock')
        ...
        .model(GTMachineModels.createWorkableCasingMachineModel('gtceu:block/casings/solid/machine_casing_heatproof', 'gtceu:block/multiblock/large_chemical_reactor'))
})