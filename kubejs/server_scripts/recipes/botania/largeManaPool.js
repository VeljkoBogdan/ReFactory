ServerEvents.recipes(event => {
    ...
    ManaPool('mana_emerald', 'minecraft:emerald', 1000, 'botanicalmachinery:mana_emerald', 10)
    ...
    ManaPool('mana_emerald_block', 'minecraft:emerald_block', 6000, 'botanicalmachinery:mana_emerald_block', 20*4)
    ...
    ManaPool('mana_powder', '#forge:dusts', 50, 'botania:mana_powder', 5)
