...
ServerEvents.recipes(event => {
    ...
    event.custom({
        "type": "ad_astra:nasa_workbench",
        "ingredients": [
            { "item": "kubejs:nestrum_rocket_nose_cone" },
            { "item": "kubejs:t3_rocket_plate" },
            { "item": "kubejs:t3_rocket_plate" },
            { "item": "kubejs:t3_rocket_plate" },
            { "item": "kubejs:t3_rocket_plate" },
            { "item": "kubejs:t3_rocket_plate" },
            { "item": "kubejs:t3_rocket_plate" },
            { "item": "kubejs:nestrum_rocket_fin" },
    ...
    // T3 Plates
    event.recipes.gtceu.forming_press("t3_welded_plate")
        .itemInputs(['16x gtceu:ostrum_plate', '16x gtceu:netherite_plate', '16x gtceu:hsss_plate', '16x gtceu:osmium_plate'])
        .circuit(1)
        .itemOutputs('kubejs:t3_welded_rocket_plate')
        .duration(20 * 8)
        .EUt(GTValues.VA[GTValues.IV])

    event.recipes.gtceu.implosion_compressor("t3_rocket_plate")
        .itemInputs(
            'kubejs:t3_welded_rocket_plate',
            '4x gtceu:industrial_tnt'
        )
        .circuit(1)
        .itemOutputs('kubejs:t3_rocket_plate')
        .duration(20)
        .EUt(GTValues.VA[GTValues.LV])
    ...
    event.recipes.gtceu.canner("ad_astra:space_suit/filling_t2")
        ...
        .circuit(1)
        .itemOutputs(Item.of('ad_astra:netherite_space_suit', '{BotariumData:{StoredFluids:[{Amount:2000L,Fluid:"gtceu:oxygen"}]}}'))
        .duration(20 * 10)
    ...
    event.recipes.gtceu.assembler("space_helmet_t1")
        ...
        .duration(160)
        .EUt(GTValues.VA[GTValues.HV])
    event.recipes.gtceu.assembler("kjs:space_pants")
        .circuit(3)
    ...
    event.recipes.gtceu.assembler("space_suit_t2")
        .itemInputs(['64x gtceu:polytetrafluoroethylene_plate', '16x gtceu:polybenzimidazole_plate', '8x gtceu:netherite_plate', '4x gtceu:stainless_steel_plate', 'ad_astra:large_gas_tank'])
        .circuit(12)
        .itemOutputs('ad_astra:netherite_space_suit')
        .duration(20*10)
        .EUt(GTValues.VA[GTValues.IV])
    event.recipes.gtceu.assembler("space_helmet_t2")
        .itemInputs(['40x gtceu:polytetrafluoroethylene_plate', '12x gtceu:polybenzimidazole_plate', '6x gtceu:netherite_plate', '3x gtceu:stainless_steel_plate', 'gtceu:glass_plate'])
        .circuit(11)
        .itemOutputs('ad_astra:netherite_space_helmet')
        .duration(20*8)
        .EUt(GTValues.VA[GTValues.IV])
    event.recipes.gtceu.assembler("kjs:space_pants_t2")
        .circuit(13)
        .itemInputs(['54x gtceu:polytetrafluoroethylene_plate', '14x gtceu:polybenzimidazole_plate', '7x gtceu:netherite_plate', '4x gtceu:stainless_steel_plate'])
        .itemOutputs("ad_astra:netherite_space_pants")
        .duration(20*8)
        .EUt(GTValues.VA[GTValues.IV])
    event.recipes.gtceu.assembler("space_boots_t2")
        .itemInputs(['32x gtceu:polytetrafluoroethylene_plate', '12x gtceu:polybenzimidazole_plate', '6x gtceu:netherite_plate', '1x gtceu:stainless_steel_plate'])
        .circuit(14)
    ...
    event.shaped(
        'kubejs:nestrum_rocket_nose_cone',
        [
            ' C ',
            'HSD',
            'SSS'
    ...
    event.shaped(
        ...
        {
            P: 'gtceu:ostrum_plate',
            S: 'gtceu:ostrum_screw',
            M: 'gtceu:iv_machine_hull',
            F: 'gtceu:tungsten_steel_rotor',
            H: '#forge:tools/hammers',
            D: '#forge:tools/screwdrivers',
            R: 'gtceu:ostrum_rod'
        }
